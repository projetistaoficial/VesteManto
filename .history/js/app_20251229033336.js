...
function renderProductsList(products, preCalcMetrics = null) {
    ...
    const checkColContent = state.isSelectionMode 
        ? `<input class="bg-gray-800" type="checkbox" onchange="toggleSelectAll(this)" ${masterCheckAttr} class="cursor-pointer rounded border-gray-600 bg-gray-800 text-yellow-500 focus:ring-0 w-4 h-4" title="Selecionar Todos">`
        : ``;
