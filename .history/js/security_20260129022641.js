...
export async function verificarStatusLoja(siteId) {
    // ... seu código de busca no Firestore ...
    // Quando você chamar a função, certifique-se de que o nome está igualzinho:
    if (dados.status !== 'ativo') {
        exibirTelaBloqueio("Sua loja está inativa."); // <--- Verifique esta linha
        return false;
    }
}
