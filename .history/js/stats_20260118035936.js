...
function calculateKPIs(orders, dailyStats) {
    // --- 1. SITE STATS (Visitas/Shares - Mantém se tiver esses elementos em outro lugar) ---
    let totalVisits = 0;
    let totalShares = 0;
    ...
    let salesCount = 0; // Vendas Confirmadas
    let salesTotal = 0; // Valor Total
    let costTotal = 0;
    ...
    // ID no HTML: "st-total-orders" (Pedidos Realizados - Tudo)
    ...
    orders.forEach(o => {
        ...
        // Status considerados como "Venda Confirmada" para somar valor
    ...
    // Taxas
    // Taxa de Aprovação = Vendas Confirmadas / Total de Pedidos
