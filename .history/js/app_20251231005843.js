...
window.openCheckoutModal = () => {
    ...
    // 2. Leitura (Com Defaults Seguros)
    const pm = state.storeProfile.paymentMethods || {};
    
    // Se active for undefined, assume true. 
    ...
    // --- A. OCULTAR PAGAMENTO ONLINE ---
    if (labelOnline) {
        if (!isOnlineEnabled) {
            labelOnline.classList.remove('flex'); 
