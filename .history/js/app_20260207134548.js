...
async function initApp() {
    ...
    // Mata Service Workers antigos que podem estar segurando o cache
    ...
    try {
        ...
        if (!snap.exists()) {
            ...
            throw new Error("SITE_DELETED"); // Joga para o catch
        }
        ...
        if (data.status === 'bloqueado' || data.active === false) {
            throw new Error("SITE_BLOCKED"); // Joga para o catch
        }
        ...
        // =================================================================
        // 3. CARREGA O SISTEMA (SOMENTE SE PASSOU NA SEGURANÇA)
        // MOVIDO PARA DENTRO DO TRY PARA NÃO RODAR SE DER ERRO
        // =================================================================
        console.log("✅ Site verificado. Carregando módulos...");
        ...
        // Monitoramento em tempo real (A cada 30s)
        // Se alguém deletar enquanto o cliente usa, ele é expulso.
        setInterval(async () => {
            try {
        ...
        if (error.message === "SITE_DELETED" || error.code === 'permission-denied' || error.code === 'unavailable') {
            exibirTelaMorte("404", "Esta loja foi encerrada ou não existe.");
        ...
        // IMPORTANTE: O return aqui impede que qualquer código abaixo seja executado
        return; 
    }
}
// =================================================================
