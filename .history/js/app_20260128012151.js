...
// --- PASSO 1: Função que calcula TUDO (Dona dos Cartões Principais) ---
async function fetchGlobalStats() {
    ...
    try {
        // Usa getDocs (Leitura Padrão) -> Não consome cota de Agregação e não precisa de índice
        ...
        if (elProfit) {
            ...
            // Pinta de Verde (Lucro) ou Vermelho (Prejuízo)
