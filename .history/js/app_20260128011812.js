...
function loadAdminSales() {
    ...
    state.salesUnsubscribe = onSnapshot(qList, (snapshot) => {
        ...
        // 2. DISPARA O CÁLCULO GLOBAL (Estatísticas)
        // Chama a função nova que baixa tudo e soma, independente da lista visual
        fetchGlobalStats();
    });
}
...
async function fetchGlobalStats() {
    ...
    try {
        ...
        // USA LEITURA PADRÃO (getDocs) EM VEZ DE AGREGAÇÃO
        // Isso consome cota de leitura (temos 50k/dia), mas não trava por cota de CPU.
        ...
        // Loop simples para somar tudo
        snapshot.forEach(doc => {
            const data = doc.data();
            totalPedidos++;
            // Garante que é numero, evitando NaN
        ...
        // Apenas se não houver busca digitada
        ...
        console.log("Estatísticas Globais Recalculadas (Via Leitura):", totalPedidos);
