...
const populateSelect = (selectEl) => {
    ...
    // LÓGICA DE TEXTO RESPONSIVO:
    // Se a tela for menor que 640px (Celular), usa "Categorias" (curto).
    // Se for maior (PC), usa "Todas as Categorias" (completo).
    const isMobile = window.innerWidth < 640; 
    const label = isMobile ? "Todas as Categorias" : "Todas as Categorias";

    // Aplica o texto variável
    selectEl.innerHTML = `<option value="" class="text-gray-500">${label}</option>`;
