...
function renderSalesList(orders) {
    ...
    orders.forEach(o => {
        ...
        // --- LÓGICA FINANCEIRA DETALHADA (CUPONS E DESCONTOS) ---
        ...
        const financePanelHTML = `
            <div class="mt-4 col-span-full">
                <button type="button" onclick="document.getElementById('admin-finance-panel-${o.id}').classList.toggle('hidden'); event.stopPropagation();" class="w-full bg-blue-900/10 hover:bg-blue-900/30 text-blue-400 border border-blue-900/50 py-3 rounded-lg text-xs font-bold transition flex justify-center items-center gap-2 outline-none uppercase tracking-wide">
                    <i class="fas fa-hand-holding-usd text-lg"></i> Resumo Financeiro (Lucro)
                </button>
                
                <div id="admin-finance-panel-${o.id}" onclick="event.stopPropagation()" class="hidden mt-3 bg-[#0a0c13] p-4 rounded-xl border border-blue-900/30 shadow-inner cursor-default">
