...
window.saveProduct = async (e) => {
    ...
    try {
        ...
        // 1. CAPTURA O ESTADO DOS CHECKBOXES (Busca robusta)
        ...
        // Se não achar pelo ID (caso tenha duplicidade), tenta buscar dentro do form específico
        ...
        console.log("Salvando - Destaque:", isHighlight); // Debug

        // 2. MONTA O OBJETO
        // ... (seu código de captura de inputs de texto continua igual) ...
        const productData = {
        ...
        // 4. LIMPEZA E REDESENHO DA LISTA
        document.getElementById('product-form-modal').classList.add('hidden');
        document.getElementById('form-product').reset();
        state.tempImages = [];
        if(typeof renderImagePreviews === 'function') renderImagePreviews();

        // Força atualização da tabela de produtos na hora
        // Isso garante que você veja a mudança (estrela/destaque) na lista imediatamente
