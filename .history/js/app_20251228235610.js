...
function renderProductsList(products, preCalcMetrics = null) {
    ...
    // --- LÓGICA DA BARRA DE AÇÃO ---
    // Só exibe o HTML se estiver no modo seleção E tiver pelo menos 1 item selecionado
    let bulkActionsHTML = '';
    if (state.isSelectionMode && state.selectedProducts.size > 0) {
        bulkActionsHTML = `
            <div class="flex items-center gap-2 animate-fade-in bg-[#151720] border border-gray-700 rounded p-1 shadow-lg">
    ...
    // --- 2. LÓGICA DO "CHECKBOX MESTRE" (CABEÇALHO) ---
    // Verifica se TODOS os produtos visíveis estão selecionados
    ...
    // A coluna do checkbox só aparece se isSelectionMode for true
