...
function loadAdminSales() {
    ...
    state.salesUnsubscribe = onSnapshot(qList, (snapshot) => {
        ...
        // 1. ATUALIZA OS CARDS DE CIMA (Dados Globais Reais - 317 pedidos)
        fetchGlobalStats(); 

        // 2. ATUALIZA OS RANKINGS DE BAIXO (Produtos, Cupons, Pagamento)
...
// ATUALIZADO: IDs corrigidos conforme seu HTML (st-*)
async function fetchGlobalStats() {
    ...
    const elTotal = document.getElementById('st-sales-val');   // <--- O ERRO ESTAVA AQUI (Era stat-sales-total)
    ...
    try {
        ...
        if (elTotalOrders) elTotalOrders.innerText = totalPedidos;
        ...
        // Atualiza também o cabeçalho da lista de pedidos
