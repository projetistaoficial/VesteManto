...
function calculateKPIs(orders, dailyStats) {
    ...
    // 2. Capital de Giro (Sempre atualiza)
    let capital = 0;
    ...
    // Só atualiza os cartões principais se NÃO for modo 'all' (Tudo).
    // Se for 'all', quem manda é o fetchGlobalStats do app.js
    // =========================================================================
    ...
    // Gráficos menores (Taxas e Status) - Sempre atualiza com base no local
