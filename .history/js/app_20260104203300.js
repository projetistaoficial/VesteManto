...
function filterAndRenderSales() {
    // 1. Captura Inputs (Com segurança para não travar)
    ...
    // Se não tiver o campo de busca principal, tenta continuar mesmo assim (evita tela branca)
    ...
    // 4. Renderiza (CORRIGIDO: Usa o ID correto 'orders-list')
    ...
    if (list) {
        ...
        if (filtered.length === 0) {
            ...
            filtered.forEach(order => {
                ...
                // Clique para abrir (Certifique-se de ter a função openAdminOrderDetail)
                div.onclick = () => {
