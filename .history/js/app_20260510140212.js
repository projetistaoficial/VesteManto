...
// =====================================================================
// ===============================================
// 1. SINCRONIZADOR VISUAL (Fundo mais escuro)
// ===============================================
...
// ===============================================
// 2. FUNÇÃO QUE FECHA OS OUTROS MENUS (NOVO)
// ===============================================
// Ouve todos os cliques da página. Se clicar num título de menu, fecha os irmãos.
document.addEventListener('click', (e) => {
    if (e.target.closest('summary')) {
        const currentDetails = e.target.closest('details');
        if (currentDetails) {
            // Acha todos os menus que estão no mesmo nível e fecha
            const allDetails = currentDetails.parentElement.querySelectorAll('details');
...
// ===============================================
// 3. RENDERIZADOR (Botões Nascem Inativos)
// ===============================================
