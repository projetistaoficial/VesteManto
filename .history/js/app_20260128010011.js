...
function loadAdminSales() {
    ...
    // 4. A MÁGICA (GLOBAL) - COLOQUE AQUI!
    // Deixe por último para garantir que ela "ganhe" e mostre os totais reais (315, R$ 5M)
    // sobrescrevendo qualquer cálculo parcial feito pelas funções acima.
