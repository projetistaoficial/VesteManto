...
async function fetchGlobalStats() {
    console.log(">>> 1. Iniciando fetchGlobalStats...");
    ...
    try {
        ...
        console.log(`>>> 2. Download concluído. Encontrados: ${querySnapshot.size} pedidos.`);

        if (querySnapshot.empty) {
            console.warn(">>> ALERTA: Nenhuma venda encontrada no banco de dados.");
            return;
        }
        ...
        console.log(`>>> 3. Cálculos: Pedidos=${totalPedidos}, Fat=${faturamentoTotal}`);

        // Atualiza a tela DIRETAMENTE
        if (elCount) elCount.innerText = totalPedidos;
        else console.error("Elemento stat-sales-count não encontrado!");
        ...
        // Atualiza Cabeçalho da Lista também
        ...
        if (elTotal) elTotal.innerText = "Erro Rede";
        alert("Erro de conexão. Verifique se o AdBlock está desligado.");
    }
}