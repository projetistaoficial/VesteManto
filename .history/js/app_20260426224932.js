...
// =================================================================
// 🖨️ MÓDULO DE IMPRESSÃO TÉRMICA - MÉTODO RAIZ (ABSOLUTO)
// =================================================================
window.printOrder = (orderId) => {
    ...
    // NOME DO ARQUIVO (O navegador vai usar isso para o PDF)
    ...
    const html = `
        ...
        <head>
            ...
            <style>
                ...
                body { font-family: 'Courier New', monospace; width: 280px; font-size: 12px; color: #000; margin: 0 auto; padding: 15px; background: #fff; }
        ...
        <body>
            ...
            <script>
                // Dispara a impressão e NÃO FECHA A ABA
    ...
    // ABRE UMA GUIA NOVA REAL, ESCREVE E DEIXA ABERTA.
    ...
    if (printWindow) {
        ...
        alert("O seu navegador bloqueou a aba de impressão. Permita pop-ups para este site lá na barra de endereços.");
    }
};