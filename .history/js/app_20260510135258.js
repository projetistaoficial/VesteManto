...
window.aplicarCoresCategorias = (catName) => {
    ...
    todosBotoes.forEach(btn => {
        // Limpa qualquer classe velha de cor que possa ter grudado no botão
        ...
        if (isAtivo) {
            ...
            // ESTADO: SELECIONADA
            // ==========================================
            // Fundo: Translúcido mais escuro para destacar
            btn.style.backgroundColor = 'rgba(0, 0, 0, 0.4)';
            // Borda e Texto: Respeitam a cor da variável do Admin
            ...
            // ==========================================
            // Fundo: Vidro levemente escurecido (combina com amarelo, branco, preto...)
            btn.style.backgroundColor = 'rgba(0, 0, 0, 0.15)';
            // Borda: Fica invisível
            btn.style.borderColor = 'transparent';
            // Texto: Respeita a cor de texto definida no seu painel
...
function renderCategories() {
    ...
    if (scrollContainer) {
        ...
        categoriasParaMostrar.forEach(c => {
            ...
            // ESTRUTURA LIMPA: Apenas formato, fonte e desfoque. As cores vêm do JS acima!
    ...
    // --- SIDEBAR (Mantém a lógica intacta) ---
