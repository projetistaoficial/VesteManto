...
function setupDeliveryDependency() {
    ...
    // =================================================================
    // 1. CHECKBOX: ENTREGA PRÓPRIA (Apenas Logística)
    // =================================================================
    ...
    newOwn.addEventListener('change', async (e) => {
        ...
        // 1. Atualiza Memória IMEDIATAMENTE (Evita que o check volte)
        ...
        // 2. Controle Visual do Código de Segurança
        const elReq = document.getElementById('conf-req-code');
        if (elReq) {
        ...
        // 3. Salva APENAS a Logística (Sem mexer no pagamento)
        // O checkout se encarrega de esconder a aba se não tiver entrega.
        await autoSaveSettings('orders');
    });

    // =================================================================
    // 2. CHECKBOX: PAGAMENTO NA ENTREGA (Apenas Financeiro)
    // =================================================================
    ...
    newPay.addEventListener('change', async (e) => {
        ...
        // 1. Validação de Segurança: Não pode ficar sem nenhum meio de pagamento
        ...
        // 2. Atualiza Memória IMEDIATAMENTE (Evita que o check volte)
        ...
        // 3. Atualiza Visual do Grupo (Opacidade)
        ...
        // 4. Salva APENAS o Pagamento (Não desliga a Entrega Própria)
        // Isso atende seu pedido: A entrega própria continua marcada no admin, 
        // mas como o pagamento está off, a aba não aparece no checkout.
