...
function renderSalesList(orders) {
    ...
    orders.forEach(o => {
        ...
        // Fallback para pedidos antigos que só tinham o código
        else if (o.cupom) {
             nomeCupom = o.cupom;
             // Em pedidos antigos não temos o valor exato salvo, então não tentamos adivinhar para não errar
        }

        // 2. Calcula se sobrou algum desconto (provavelmente Pix)
        // Matematica: (Total Itens + Frete - Desconto Cupom) - Total Pago = Desconto Pix
        ...
        // Se tem cupom ou desconto pix, monta o bloco
        if (valDescontoCupom > 0 || valDescontoPix > 0.05 || nomeCupom) {
