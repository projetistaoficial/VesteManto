...
// Função para configurar os Listeners de Dependência (ATUALIZADA)
function setupDeliveryDependency() {
    ...
    newOwn.addEventListener('change', (e) => {
        ...
        // REGRA: Se desativar entrega -> Desativa pagamento
        if (!isActive) {
    ...
    newPay.addEventListener('change', (e) => {
        ...
        if (ownCheck) {
            ...
            // B) SE DESATIVAR PAGAMENTO -> Desativa Entrega Automaticamente (NOVO)
            else {
                if (ownCheck.checked) {
