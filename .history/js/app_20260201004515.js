...
function setupEventListeners() {
    ...
    // Sidebar e UI Geral
    const btnMob = getEl('mobile-menu-btn'); if (btnMob) btnMob.onclick = toggleSidebar; // <--- CORRIGIDO
    const btnCloseSide = getEl('close-sidebar'); if (btnCloseSide) btnCloseSide.onclick = toggleSidebar; // <--- CORRIGIDO
    if (els.sidebarOverlay) els.sidebarOverlay.onclick = toggleSidebar; // <--- CORRIGIDO
    ...
    if (btnFinishPayment) {
        btnFinishPayment.onclick = submitOrder;
    }
