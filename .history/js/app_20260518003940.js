...
// =================================================================
// 🖨️ PONTE PARA EXPORTAÇÃO (Chama o arquivo utilitarios.js)
// =================================================================
window.exportProductsExcel = () => {
    ...
    if (typeof window.gerarPlanilhaEstoque === 'function') {
        window.gerarPlanilhaEstoque(products);
        showToast("Planilha gerada com sucesso!", "success");
    } else {
        alert("Erro: O arquivo utilitarios.js não carregou corretamente.");
    }
};
...
window.exportProductsPDF = () => {
    ...
    if (typeof window.gerarPDFEstoque === 'function') {
