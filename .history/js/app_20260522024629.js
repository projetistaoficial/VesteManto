...
function showToast(message, type = 'success') {
    ...
    if (!toast) {
        ...
        // ✨ CORREÇÃO: O z-index foi de z-[100] para z-[999999] para ficar acima de qualquer modal!
        toast.className = 'fixed top-4 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white px-6 py-3 rounded shadow-2xl z-[999999] transition-all duration-300 opacity-0 translate-y-[-20px] border border-gray-700 font-bold flex items-center gap-2';
    ...
    // Se for erro, muda a borda para vermelho para chamar mais atenção (Opcional visual)
    if (type === 'error') {
    ...
    // Remove depois de 2 segundos (Aumentei um pouquinho o tempo de leitura)
    setTimeout(() => {
