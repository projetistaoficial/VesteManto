            ...
            <div id="admin-finance-panel-${o.id}" onclick="event.stopPropagation()" class="hidden mt-4 mb-2 bg-[#0a0c13] p-4 rounded-xl border border-blue-900/30 shadow-inner cursor-default">
                <div class="flex justify-between items-center mb-3 border-b border-blue-900/30 pb-2">
                    ...
                    <div class="flex gap-2">
                        <button type="button" onclick="exportFinancePDF('${o.id}')" class="font-bold bg-red-900/20 hover:bg-red-900/40 text-red-400 border border-red-900/30 px-2 py-1 rounded text-[9px] font-bold uppercase transition flex items-center gap-1"><i class="fas fa-file-pdf"></i> PDF</button>
                        <button type="button" onclick="exportFinanceExcel('${o.id}')" class="font-bold bg-green-900/20 hover:bg-green-900/40 text-green-400 border border-green-900/30 px-2 py-1 rounded text-[9px] font-bold uppercase transition flex items-center gap-1"><i class="fas fa-file-excel"></i> Excel</button>
                    </div>
                </div>
