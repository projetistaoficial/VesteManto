...
function setupEventListeners() {
    ...
    // Lógica de Troca de Abas (Com atualização forçada de Vendas)
    document.querySelectorAll('.tab-btn').forEach(btn => {
        btn.onclick = () => {
            ...
            // Se clicou na aba de Vendas, força o redesenho da lista
            if (btn.dataset.tab === 'tab-vendas' || btn.id === 'admin-menu-sales') {
                if (typeof filterAndRenderSales === 'function') {
                    filterAndRenderSales();
                }
            }
    ...
    // Garante que o clique no botão de vendas sempre atualize a lista
