...
// ATUALIZADO: IDs corrigidos para bater com seu HTML (st-*)
async function fetchGlobalStats() {
    console.log(">>> Iniciando busca global (IDs corrigidos)...");

    // Mapeamento dos IDs do seu HTML
    const elCount = document.getElementById('st-sales-count'); // Era stat-sales-count
    const elTotal = document.getElementById('st-sales-val');   // Era stat-sales-total
    const elCost = document.getElementById('st-cost');         // Era stat-cost-total
    const elProfit = document.getElementById('st-profit');     // Era stat-profit-total
    const elTotalOrders = document.getElementById('st-total-orders'); // Total Geral
    ...
    try {
        ...
        console.log(`>>> Dados Calculados: Pedidos=${totalPedidos}, Fat=${faturamentoTotal}`);

        // Atualiza a tela com os IDs CERTOS
        if (elCount) elCount.innerText = totalPedidos;
        if (elTotalOrders) elTotalOrders.innerText = totalPedidos; // Atualiza também o contador "Pedidos Realizados"
        ...
        if (!searchInput || searchInput.value === '') {
            ...
            if (headerTotal) {
                ...
                if (headerTotal.previousElementSibling) headerTotal.previousElementSibling.innerText = 'TOTAL GLOBAL';
            }
        }
