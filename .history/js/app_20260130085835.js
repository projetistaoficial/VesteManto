...
function setupEventListeners() {
    ...
    // --- CORREÇÃO: Removemos o 'window.' para usar a função local ---
    if (els.checkoutCep) {
        els.checkoutCep.addEventListener('blur', handleCheckoutCep); // <--- MUDOU AQUI
    }
    ...
    // ====================================================================
    // AQUI ESTÃO AS CORREÇÕES (REMOVIDO 'window.')
    // ====================================================================
    
    // Carrinho Desktop
    const btnCart = document.getElementById('cart-btn');
    if (btnCart) {
        // CORREÇÃO: use openCart direto, sem window.
    ...
    if (btnCartMob) {
        // CORREÇÃO: use openCart direto
        btnCartMob.onclick = openCart; 
    }
    ...
    // Sidebar e UI Geral
    // CORREÇÃO: use toggleSidebar direto
    ...
    // CORREÇÃO: Remover 'window.' também aqui
