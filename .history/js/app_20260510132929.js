...
function renderCategories() {
    ...
    if (scrollContainer) {
        ...
        categoriasParaMostrar.forEach(c => {
            ...
            // Estrutura Base: Fundo sempre translúcido (vidro fosco), borda, fonte grossa
            const classesEstrutura = "categoria-btn flex items-center h-full rounded-full transition-all shrink-0 border backdrop-blur-md font-black tracking-wide text-xs outline-none bg-white/5 border-transparent text-[var(--txt-body)] opacity-70";
        ...
        // Pinta a cor correta baseada no painel imediatamente
