...
window.openCheckoutModal = () => {
    ...
    const onlineActive = pm.online?.active !== false;     // Padrão true
    const deliveryActive = pm.delivery?.active !== false; // Padrão true

    // Compatibilidade com logística antiga (opcional, se quiser manter)
    ...
    // Só mostra se o Financeiro permitir E a Logística permitir
    if (!deliveryActive || !logisticsActive) {
    ...
    else if (deliveryActive && logisticsActive) {
