...
function openProductModal(productId) {
    ...
    // =================================================================
    // ✨ PREENCHIMENTO DE TEXTOS E LÓGICA DO "VER MAIS"
    // =================================================================
    ...
    if (elDesc) {
        ...
        // Remove botão antigo se existir (para não duplicar ao abrir outro produto)
        const oldBtn = document.getElementById('btn-read-more');
        if (oldBtn) oldBtn.remove();

        // Se o texto for muito grande (mais de 150 caracteres ou muitas quebras de linha)
        if (fullText.length > 150 || (fullText.match(/\n/g) || []).length > 2) {
            // Aplica o corte via CSS nativo
            elDesc.style.display = '-webkit-box';
            elDesc.style.webkitLineClamp = '3'; // Corta na 3ª linha
            ...
            // Lógica de alternar entre "Ver mais" e "Ver menos"
            btnMore.onclick = () => {
            ...
            // Insere o botão logo abaixo da descrição
            elDesc.parentNode.insertBefore(btnMore, elDesc.nextSibling);
        } else {
            // Se for texto pequeno, garante que não tem corte
            elDesc.style.webkitLineClamp = 'unset';
        }
    }
    // =================================================================
