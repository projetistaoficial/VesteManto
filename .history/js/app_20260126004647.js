            ...
            if (pixGlobal.mode === 'total') {
                ...
                <div class="flex flex-col gap-1 mt-1">
                    <div class="flex items-center gap-2 text-sm text-gray-300">
                        ...
                        <span class="text-green-400 font-bold">${labelOff} no Pix</span>
                    </div>
                    <p class="text-[10px] text-gray-500 pl-6 italic">* Desconto aplicado no valor total da venda.</p>
                </div>`;
            } else {
                // MODO PRODUTO
                let valDesconto = 0;
                if (isFixed) valDesconto = pixGlobal.value;
                else valDesconto = priceFinal * (pixGlobal.value / 100);
