...
// ATUALIZADO: Sem orderBy para facilitar a indexação
async function updateRealTotals() {
    ...
    try {
        ...
        // REMOVIDO: orderBy('total'). 
        // MOTIVO: Não precisamos ordenar para somar. Isso simplifica o índice necessário.
        ...
        // Define cor do lucro (Verde se positivo, Vermelho se negativo)
        if (dashTotalProfit) {
        ...
        console.log("Totais atualizados:", { totalPedidos, faturamentoTotal, custoTotalAgregado });

    } catch (error) {
        console.error("Erro ao buscar totais:", error);
        
        // Mensagem amigável se faltar o índice
        if (error.message.includes("requires an index")) {
            console.warn("⚠️ CLIQUE NO LINK DO CONSOLE PARA CRIAR O ÍNDICE!");
            // Tenta mostrar um aviso na tela para você não esquecer
            if (headerTotalValue) headerTotalValue.innerText = "Criando Índice...";
        }
    }
}