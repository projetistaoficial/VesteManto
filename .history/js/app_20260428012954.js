...
window.openProductModal = (productId) => {
    ...
    // ✨ FORÇA BRUTA NO CSS PARA A IMAGEM COBRIR TUDO
    if (!document.getElementById('style-modal-fullscreen')) {
        const style = document.createElement('style');
        style.id = 'style-modal-fullscreen';
        style.innerHTML = `
            ...
            /* FORÇA A IMAGEM PRINCIPAL A PREENCHER 100% DO ESPAÇO COMO FUNDO */
            #modal-img {
            ...
            /* FORÇA AS MINIATURAS A FLUTUAREM EM CIMA DA IMAGEM NO RODAPÉ */
            #modal-thumbnails {
                position: absolute !important;
    ...
    // Coluna esquerda agora é apenas um "container" relativo para a imagem absoluta preencher
    if (imgCol) {
        imgCol.className = "w-full md:w-1/2 h-[40vh] md:h-full relative shrink-0 overflow-hidden bg-black";
    }

    // Coluna direita (textos) rolável
    if (rightCol) {
