...
window.openProductModal = (productId) => {
    ...
    // ✨ 1. A SOLUÇÃO DEFINITIVA: Injeção de CSS com Força Bruta (Position Absolute)
    if (!document.getElementById('style-product-modal-image')) {
        ...
        style.innerHTML = `
            ...
            #modal-img {
                ...
                object-fit: cover !important; /* Preenche sem distorcer (corta as rebarbas) */
                object-position: center !important; /* Mantém o meio da foto focado */
                z-index: 1 !important;
            }
    ...
    // ✨ 2. COLUNA DA IMAGEM: Fica 'relative' para segurar a imagem 'absolute' dentro dela
    // O 'md:h-auto' garante que ela estique para acompanhar a altura do texto da direita!
    if (imgCol) {
    ...
    // 4. GARANTE A ORDEM: Tamanho sempre ACIMA do Botão Adicionar
    if (sizesWrapper && btnAdd && sizesWrapper.parentElement === btnAdd.parentElement) {
        ...
        // Remove e recoloca na ordem correta
