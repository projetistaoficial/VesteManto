...
function renderOrdersSummary(orders, filterStatus = '') {
    ...
    cards.forEach(card => {
        ...
        // Agora a variável 'html' existe, então o += funciona
        html += `
...
function setupAuthListener() {
    ...
    onAuthStateChanged(auth, (user) => {
        ...
        const btnLogin = document.getElementById('menu-btn-admin'); // Mobile/Desktop
        const btnLoginModal = document.getElementById('btn-admin-login'); // Botão dentro do modal
