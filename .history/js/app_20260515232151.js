    ...
    if (sidebarContainer) {
        ...
        if (activeTopics.length > 0) {
            ...
            activeTopics.forEach((topic) => {
                ...
                sidebarContainer.innerHTML += `
                    <button onclick="openClientTopic(${originalIndex})" class="w-full text-left py-2.5 px-4 text-sm font-bold text-gray-400 hover:text-white hover:bg-gray-800 rounded transition flex items-center gap-3 text-[var(--txt-body)]">
