...
function setupDeliveryDependency() {
    ...
    // =================================================================
    // 2. MEXEU NO PAGAMENTO NA ENTREGA (AJUSTADO)
    // =================================================================
    ...
    newPay.addEventListener('change', async (e) => {
        ...
        // --- LÓGICA DO AVISO (SEM ATIVAR AUTOMATICAMENTE) ---
        const ownCheck = document.getElementById('conf-own-delivery');
        ...
        if (ownCheck) {
            ...
            if (isActive) {
                ...
                if (!ownCheck.checked) {
                    // APENAS AVISA. Não mexe no checkbox da entrega.
                    showSystemModal("⚠️ Atenção:\n\nA 'Entrega Própria' está desativada.\n\nEmbora você tenha ativado o pagamento, ele NÃO aparecerá no checkout até que a entrega seja ativada.", "warning");
                }
            }
        }
