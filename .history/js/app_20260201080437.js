...
function setupEventListeners() {
    ...
    if (elReqCode) {
        // Remove cloneNode aqui, usa addEventListener direto
        // Para garantir que não duplique, poderíamos remover o listener anterior se tivéssemos a referência,
        // mas como a página carrega uma vez, adicionar direto é seguro.
