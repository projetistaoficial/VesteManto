...
// =================================================================
// =================================================================
// 🖨️ MÓDULO DE IMPRESSÃO TÉRMICA - COM LOGO E ENDEREÇO
// =================================================================
window.printOrder = (orderId) => {
    ...
    // HTML da Logo (Se existir, renderiza em P&B para impressoras térmicas)
    const logoHtml = storeProfile.logo 
        ? `<img src="${storeProfile.logo}" style="max-width: 140px; center max-height: 100px; object-fit: contain; margin-bottom: 8px; filter: grayscale(100%) contrast(1.2);"><br>` 
        : '';
