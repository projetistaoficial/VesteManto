...
// =================================================================
// 🖨️ MÓDULO DE IMPRESSÃO TÉRMICA - VERSÃO FILENAME DEFINITIVO
// =================================================================
window.printOrder = (orderId) => {
    ...
    // ✨ CONFIGURAÇÃO DO NOME DO ARQUIVO (Sem espaços ou #)
    const fileName = `Pedido_${orderNumber}`;
    const oldTitle = document.title; // Guarda o título original do painel
    ...
    // 2. ✨ TRUQUE DO TÍTULO: Muda o título da página principal temporariamente
    // O navegador usa o título da PÁGINA PAI para nomear o PDF ao imprimir iframes.
    ...
    setTimeout(() => {
        ...
        // 4. ✨ RESTAURA O TÍTULO: Volta o nome do painel original após fechar a caixa de impressão
