...
window.openCheckoutModal = () => {
   ...
   // 4. Exibição das Telas
    ...
    // ✨ CORREÇÃO AQUI: Agora a tela está visível. Invocamos as funções que filtram os botões na memória.
    ...
    // Roda os filtros de pagamento para ocultar opções desativadas instantaneamente
    if (typeof togglePaymentMode === 'function') togglePaymentMode();
