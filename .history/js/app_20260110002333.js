...
function renderSalesList(orders) {
    ...
    orders.forEach(o => {
        ...
        switch (o.status) {
            ...
            case 'Reembolsado': statusColorClass = 'text-purple-500'; break; // Cor Roxo para Reembolsado
        }
        ...
        // --- CONTROLES (AQUI ESTÁ A LÓGICA PEDIDA) ---
        let controlsHtml = '';
