...
window.openCheckoutModal = () => {
    ...
    // 2. Prepara visual (mas ainda bloqueado)
    ...
    // 4. FORÇA O BLOQUEIO INICIAL
    // Como limpamos os campos acima, isso vai travar a seção de pagamento imediatamente.
...
// Função que LIBERA ou TRAVA o pagamento
function validateCheckoutForm() {
    ...
    // O campo Rua é preenchido pelo CEP. Se estiver vazio, não buscou o CEP.
