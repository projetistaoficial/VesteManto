...
// =================================================================
// 🚨 CORREÇÃO DEFINITIVA DE ESCOPO (COLE NO FINAL DO ARQUIVO) 🚨
// =================================================================
...
// 2. Funções de Checkout e Pedidos
window.goToCheckoutView = goToCheckoutView;
window.backToOrderList = backToOrderList;
...
// 3. Funções de Produto
window.openProductModal = openProductModal;
window.closeProductModal = closeProductModal;
window.addToCart = addToCart;
window.changeQty = changeQty;
window.updateCartQtyCard = updateCartQtyCard;
window.selectSizeCard = selectSizeCard;
window.addToCartCard = addToCartCard;
...
// 4. Funções Administrativas (Produtos)
...
window.bulkMoveDynamic = bulkMoveDynamic;
...
// 5. Funções Administrativas (Pedidos e Status)
window.loadAdminSales = loadAdminSales; // Força recarregar vendas
window.renderOrdersSummary = renderOrdersSummary; // Força desenhar painel
window.filterAndRenderSales = filterAndRenderSales;
window.openAdminOrderDetail = openAdminOrderDetail;
window.handleStatusChange = handleStatusChange;
window.adminFinalizeOrder = adminFinalizeOrder;
window.adminCancelOrder = adminCancelOrder;
window.adminRefundOrder = adminRefundOrder;
window.adminRevertStatus = adminRevertStatus;
window.toggleOrderAccordion = toggleOrderAccordion;
window.markAsViewed = markAsViewed;

// 6. Funções Administrativas (Cupons e Categorias)
...
window.applyCouponDynamic = applyCouponDynamic;
window.removeCoupon = removeCoupon;
window.selectParentCategory = selectParentCategory;
...
window.cancelPixGlobal = cancelPixGlobal;
window.removeStoreBanner = removeStoreBanner;
window.loadTheme = loadTheme;
...
// 9. FORÇAR ATUALIZAÇÃO DOS DADOS AGORA
console.log("✅ Sistema reiniciado. Forçando atualização de dados...");
if (state.user) {
    console.log("🔄 Recarregando vendas e estatísticas...");
    loadAdminSales(); 
} else {
    console.log("ℹ️ Visitante: Vendas ocultas.");
}
// =================================================================