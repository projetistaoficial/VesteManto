...
async function saveClientData() {
    ...
    if (planData.nextDue && finalStatus === 'ativo') {
        ...
        if (hoje > venc) {
            ...
            if (diffDays > carenciaDias) {
                ...
                // Atualiza a tela do painel na hora para você ver a mudança
    ...
    const data = {
        ...
        status: finalStatus, // 🔥 AGORA SALVA O STATUS CORRIGIDO
        active: finalActive, // 🔥 AGORA SALVA A TRAVA CORRIGIDA
        ownerData: {
