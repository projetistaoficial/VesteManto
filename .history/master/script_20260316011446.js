...
// =================================================================
// FUNÇÃO DE BUSCA INTELIGENTE (Nome, ID ou URL)
// =================================================================
window.filterClients = (searchTerm) => {
    // Se o campo estiver vazio, mostra todos os clientes originais
    ...
    const filtered = allClients.filter(c => {
        ...
        // Retorna verdadeiro se bater com o nome, com a URL ou com o ID Numérico
        return matchName || matchSlug || matchCode;
    });
    
    // Renderiza a lista com o resultado
