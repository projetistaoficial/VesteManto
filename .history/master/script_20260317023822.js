...
function renderInvoices(faturas) {
    ...
    faturas.forEach(f => {
      ...
      if (f.status === 'pago') {
            ...
            // Verifica se está atrasado e calcula os dias
            ...
            if (isAtrasado) {
                statusHtml = `
                    <div class="flex flex-col items-center">
                        <span class="bg-red-600 text-white px-3 py-1 rounded text-[10px] font-bold uppercase block w-full text-center">Atrasado</span>
