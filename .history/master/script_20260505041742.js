...
window.toggleLeadsBlock = () => {
    ...
    if (container.classList.contains('h-20')) {
        ...
        container.classList.remove('h-20', 'w-1/2', 'border-gray-800');
        // Adiciona estado TELA CHEIA (Absolute cobre o outro lado)
        container.classList.add('h-full', 'w-full', 'absolute', 'top-0', 'right-0', 'z-[100]', 'border-l-2', 'border-yellow-500/50', 'shadow-[-15px_0_30px_rgba(0,0,0,0.6)]');
        arrow.classList.add('rotate-180');
    } else {
        // FECHA: Remove estado tela cheia
        container.classList.remove('h-full', 'w-full', 'absolute', 'top-0', 'right-0', 'z-[100]', 'border-l-2', 'border-yellow-500/50', 'shadow-[-15px_0_30px_rgba(0,0,0,0.6)]');
        // Volta ao estado original (no canto dele)
        container.classList.add('h-20', 'w-1/2', 'border-gray-800');
        arrow.classList.remove('rotate-180');
    }
};
