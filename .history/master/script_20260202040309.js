...
function renderClients(clients) {
    ...
    clients.forEach(client => {
        ...
        const displayId = client.docId; // slug
        ...
        // Clique na linha abre o modal (exceto se clicar no link ou checkbox)
        row.onclick = (e) => {
        ...
        // Coluna LINK atualizada: Texto truncado + Ícone de Copiar
        row.innerHTML = `
...
async function openClientModal(docId = null) {
    ...
    if (docId) {
        ...
        if (client) {
            ...
            const linkInput = document.getElementById('inp-site-link');
