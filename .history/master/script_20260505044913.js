...
window.abrirDetalheLead = (id) => {
    ...
    // 🌟 LÓGICA DO MODAL FECHADO VS ABERTO
    ...
    if (lead.status === 'Fechado') {
        // Exibe o banner verde e esconde as ações de venda
        ...
        // Puxa a data em que o negócio foi fechado (Se existir)
        if (lead.dataFechamento) {
            ...
            textDataFechamento.innerText = "Data não registrada"; // Pra leads antigos fechados antes dessa atualização
        }
    } else {
        // Modal Normal de Vendas (Oculta banner verde, mostra botões de fechar/recusar)
    ...
    // Marca como pendente (visto) se for um lead novo e você acabou de abrir
